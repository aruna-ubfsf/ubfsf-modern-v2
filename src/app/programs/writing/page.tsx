...
export default function WritingBeyondThePrisonPage() {
  const projectData = {
    title: "Writing Beyond the Prison: A Struggle for Freedom",
    type: "Documentary Film",
    fundraisingGoal: "500,000 USD",
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#1a1a1a] text-black dark:text-[#f4f4f4] transition-colors duration-300 font-serif">
      <header className="relative h-[40vh] flex items-end pb-20 px-6 md:px-20 overflow-hidden border-b border-black/10 dark:border-white/10">
      ...
      <section className="max-w-7xl mx-auto py-16 px-6 md:px-20">
        ...
        {/* The rest of your sections remain the same below... */}
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="bg-stone-50 dark:bg-[#2a2a2a] p-8 rounded-2xl border border-black/5 dark:border-white/5">
            <p className="text-stone-600 dark:text-stone-400 leading-relaxed">{projectData.needs}</p>
          </div>
        </div>
